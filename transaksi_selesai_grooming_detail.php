...
<?php 
     ...
     $faktur= mysqli_real_escape_string($conn,$_GET['id_transaksi_grooming']);
...
<p align="right">
  <a href='invoice_grooming.php?id_transaksi_groomin=<?php echo $faktur; ?>'>
...
<div id="no-more-tables">
  <?php
  $faktur= mysqli_real_escape_string($conn,$_GET['id_transaksi_grooming']);                    // Panggil data faktur
