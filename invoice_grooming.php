...
$id_transaksi_grooming 	 = 	mysqli_real_escape_string($conn,$_GET['id_transaksi_grooming']);
...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    ...
    <title>Invoice #<?php echo $id_transaksi_grooming; ?></title>
    <style type="text/css">
		.tabel2 {
		  width: 100%;
  ...
  <body>
		...
		<h3 align="center">NO. INVOICE: #<?php echo $id_transaksi_grooming; ?></h3>
		...
		<table class="tabel2" align="right">
		  <thead>
		    <tr>
		      ...
		      <td style="text-align: center; background: #ddd"><b>JAM</b></td>
		      <td style="text-align: center; background: #ddd"><b>PETUGAS</b></td>
        ...
        ?>
          <tr>
            ...
            <td style='text-align: center; width:155px'><?php echo $data_invoice['jam_mulai'] ?> - <?php echo $data_invoice['jam_selesai'] ?></td>
            <td style='text-align: center; width:50px'><?php echo $data_invoice['nama_petugas'] ?></td>
		...
		<hr/>
          <?php 
          $query1        = "SELECT sum(subtotal) AS grandtotal,status_order FROM transaksi_grooming_detail
